...
str14='sdChfac_time';
fprintf('\n');
fprintf('start RS SVD vs CHEB ID comparison 2D:');
fprintf('\n');
...
%    saveas(bf,'image13a.jpg');
    ...
    if flag > 0
       saveas(pic,['Comp_RSFFT_CHEBNF_uni1_2D.eps'],'epsc');
    else 
       saveas(pic,['Comp_RSFFT_CHEBNF_non1_2D.eps'],'epsc');
    end
    hold off;
    pic = figure;
    hold on;
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic,['Comp_RSFFT_CHEBNF_uni2_2D.eps'],'epsc');
    else 
       saveas(pic,['Comp_RSFFT_CHEBNF_non2_2D.eps'],'epsc');
    end
    hold off;
    pic1 = figure;
    hold on;
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic1,['CompFN_relerr_uni_2D.eps'],'epsc');
    else 
       saveas(pic1,['CompFN_relerr_non_2D.eps'],'epsc');
    end
    hold off;
    pic2 = figure;
    hold on;
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic2,['CompFN_rank_uni_2D.eps'],'epsc');
    else 
       saveas(pic2,['CompFN_rank_non_2D.eps'],'epsc');
    end
