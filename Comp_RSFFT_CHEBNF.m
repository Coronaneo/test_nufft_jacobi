...
%    saveas(bf,'image13a.jpg');
    ...
    if flag > 0
       saveas(pic,['Comp_RSFFT_CHEBNF_uni1-140.eps'],'epsc');
    else 
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic,['Comp_RSFFT_CHEBNF_uni2-140.eps'],'epsc');
    else 
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic1,['CompFN_relerr_uni-140.eps'],'epsc');
    else 
    ...
    set(b.XLabel, 'FontSize', 20);set(b.YLabel, 'FontSize', 20);set(b.ZLabel, 'FontSize', 20);set(b.Title, 'FontSize', 20);
    if flag > 0
       saveas(pic2,['CompFN_rank_uni-140.eps'],'epsc');
    else 
