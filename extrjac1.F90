...
n1 = n1*m1
n2 = n2*m2
allocate(t(n1),k(n2),t1(n1),k1(n2),m(n1,n2),r(n))
...
if (k1(i) .gt. it) then
    ...
    call jacobi_phase_eval(chebdata,dnu,da,db,nints,ab,avals,psivals,n,ts,avals0,psivals0)
...
deallocate(twhts,ab,t,k,t1,k1,m,r,ts,xs,avals,psivals,avals0,psivals0)
