...
all : ${ALLOBJ} ${ALLOBJ1} ${ALLOBJ2} ${ALLOBJ3} nufft1dIInyumex.mex jacobiexample.mex chebjacex.mex nufft2dIInyumex.mex directjac2.mex extrjac2.mex directjac3.mex \
	extrjac3.mex nufft3dIInyumex.mex directjac1.mex extrjac1.mex getts.mex directinvjac1.mex
...
LINK_MACRO = $< nufft1dIInyumex.o jacobiexample.o chebjacex.o nufft2dIInyumex.o directjac2.o extrjac2.o directjac3.o extrjac3.o nufft3dIInyumex.o directjac1.o extrjac1.o getts.o directinvjac1.o -o $@
